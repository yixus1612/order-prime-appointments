...
public class ProfilePage {
    ...
    public void SetupPageSwitching(Stage primaryStage, HomePage Home, CalendarPage Calendar, PlacesPage Places, AppointmentsPage Appointments, SettingsPage Settings){
