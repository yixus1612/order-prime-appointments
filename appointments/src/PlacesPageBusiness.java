...
public class PlacesPageBusiness {
    ...
    public PlacesPageBusiness(Stage primaryStage){
    ...
    public HBox sideBar(Stage primaryStage){
        ...
        homeTabRectangle.setOnMouseClicked(e -> switcher.switchToHomePageBusiness(placesPage.getWindow(), primaryStage));
        homeTabText.setOnMouseClicked(e -> switcher.switchToHomePageBusiness(placesPage.getWindow(), primaryStage));

        profileTabRectangle.setOnMouseClicked(e -> switcher.switchToProfilePageBusiness(placesPage.getWindow(), primaryStage));
        profileTabText.setOnMouseClicked(e -> switcher.switchToProfilePageBusiness(placesPage.getWindow(), primaryStage));

        calendarTabRectangle.setOnMouseClicked(e -> switcher.switchToCalendarPageBusiness(placesPage.getWindow(), primaryStage));
        calendarTabText.setOnMouseClicked(e -> switcher.switchToCalendarPageBusiness(placesPage.getWindow(), primaryStage));
        
        settingsTabRectangle.setOnMouseClicked(e -> switcher.switchToSettingsPageBusiness(placesPage.getWindow(), primaryStage));
        settingsTabText.setOnMouseClicked(e -> switcher.switchToSettingsPageBusiness(placesPage.getWindow(), primaryStage));
