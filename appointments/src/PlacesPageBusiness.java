...
public class PlacesPageBusiness {
    ...
    public void SetupPageSwitching(Stage primaryStage, HomePageBusiness Home, ProfilePageBusiness Profile, CalendarPageBusiness Calendar, SettingsPageBusiness Settings){
