...
public class SettingsPageBusiness {
    ...
    public void SetupPageSwitching(Stage primaryStage, HomePageBusiness Home, ProfilePageBusiness Profile, CalendarPageBusiness Calendar, PlacesPageBusiness Places){
